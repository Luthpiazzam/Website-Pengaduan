                        ...
                        @else
                            <ul class="navbar-nav text-center ml-auto">
                                ...
                                <li class="navbar-item">
                                    <a href="/register" class="btn btn-outline-purple">Register</a>
                                </li>
                            </ul>
                        @endauth
                </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 Liem • All rights reserved</p>
    </div>
</div>
{{-- Penutup Body --}}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="back-to-landing" style="background: Cyan; width: 100%; text-align: center; padding: -3;">
                    <a href="{{route('ereporthub.index')}}">Back</a>
                </div>
